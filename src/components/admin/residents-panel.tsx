...
/**
 * The resident register as the control console sees it.
 *
 * Listed in full here (censored rows included, since this is the only view that
 * may see them) and each row carries one switch: censored records are withheld
 * from `/api/search-residents`, `/api/address-residents`, the /grid feeds and
 * the JSON export, without the row itself being deleted.
 */
...
export function ResidentsPanel() {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      {/* ----------------------------------------------------------- controls -- */}
      <div className="shrink-0 border-b border-[var(--mx-line)] bg-black/70 px-3 py-2">
